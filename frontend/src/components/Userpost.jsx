...
//   useEffect(() => {
//     fetchPosts();
//   }, [sortOrder]);  // Re-fetch posts when sorting changes
...
//       if (sortOrder === 'newest') {
//         sortedPosts = sortedPosts.sort((a, b) => new Date(b.createdAt) - new Date(a.createdAt));  // Newest first
//       } else if (sortOrder === 'oldest') {
//         sortedPosts = sortedPosts.sort((a, b) => new Date(a.createdAt) - new Date(b.createdAt));  // Oldest first
//       }
...
// export default Userpost; //filter
